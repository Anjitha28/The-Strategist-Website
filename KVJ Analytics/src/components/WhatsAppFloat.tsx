...
export function WhatsAppFloat({ phone = "15550102030" }: { phone?: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[9998] flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-white font-bold text-sm shadow-[0_8px_30px_rgba(37,211,102,0.45)] hover:scale-105 transition-transform"
    >
