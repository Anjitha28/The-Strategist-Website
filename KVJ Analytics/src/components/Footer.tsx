...
export function Footer({ siteSettings = FALLBACK_SITE_SETTINGS }: FooterProps) {
  ...
  return (
    <footer className="bg-base-2/85 backdrop-blur-xl text-ink pt-16 pb-8 border-t border-line/50 relative overflow-hidden">
      {/* Ambient backgrounds */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-brand/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-corporate/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-12 mb-16">
          ...
          <div className="lg:col-span-3 flex flex-col justify-start">
            ...
            <p className="text-sm text-slate/85 leading-relaxed mb-8 max-w-sm font-light">
              {description}
            </p>
            {/* Regions badge strip */}
