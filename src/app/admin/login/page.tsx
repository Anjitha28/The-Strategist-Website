...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050608] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-purple-500/10 rounded-full blur-[120px] pointer-events-none translate-x-1/2 translate-y-1/2" />
      ...
      <div className="max-w-md w-full bg-[#0E1117]/65 backdrop-blur-xl rounded-[24px] border border-white/5 p-8 md:p-10 shadow-[0_24px_50px_-12px_rgba(0,0,0,0.6)] relative z-10 overflow-hidden">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative group">
              ...
              <div className="relative px-6 py-4 bg-[#050608]/90 border border-white/5 rounded-2xl flex items-center justify-center">
                <span className="text-white font-display font-bold text-lg tracking-wide">THE STRATEGIST</span>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border border-white/5 bg-[#050608]/50 text-white placeholder-zinc-600 focus:outline-none focus:border-[#3A7BFF]/40 focus:ring-1 focus:ring-[#3A7BFF]/40 text-sm transition-all focus:bg-[#050608]/80"
              />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-gradient-to-r from-[#3A7BFF] to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold rounded-xl shadow-[0_0_20px_rgba(58,123,255,0.15)] hover:shadow-[0_0_30px_rgba(58,123,255,0.3)] transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center space-x-2 border-none cursor-pointer"
          >
            {loading ? (
              <>
