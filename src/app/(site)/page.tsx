...
import { ArrowRight, ChevronRight, BarChart3, Workflow, Gauge, PieChart, Zap, Cpu, GraduationCap, Award, BookOpen, Target, Settings, ShieldCheck, Play } from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <>
      {/* ================================================================
          HERO — Responsive split-column layout matching reference screenshot
          Left Column: Live HTML Text, Kicker, Serifs, Custom Buttons
          Right Column: Clean Cropped Growth Visual
          Design language: #071820 ink, #18b8ad teal, #ffffff bg
          ================================================================ */}
      <section
        className="relative w-full overflow-hidden pt-[90px] lg:pt-[100px]"
        style={{ background: "#ffffff" }}
      >
        {/* Full-width upscaled high-res integrated hero image */}
        <div className="relative w-full">
          <Image
            src="/brand/hero-reference.png"
            alt="From Insights to Impact — The Strategist growth visualization and integrated strategic metrics dashboard"
            width={1576}
            height={822}
      ...
      {/* ================================================================
          SOLUTIONS — Dark ink section (matches reference HTML)
          ================================================================ */}
      <section
        id="solutions"
        className="py-24"
        style={{ background: "#071820", color: "#effffd" }}
      >
        <div className="container-page">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-8 mb-11">
            <div>
              <p
                style={{ fontSize: "10px", fontWeight: 900, letterSpacing: "0.2em", color: "#7ce3da" }}
                className="uppercase"
              >
                Corporate Solutions
              </p>
              ...
              <p
                ...
                style={{ color: "#a1b4b9", fontSize: "14px" }}
              >
          ...
          <RevealGroup className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {SITE_CONFIG.corporate.solutions.slice(0, 6).map((sol, i) => (
              <RevealItem key={sol.title}>
                ...
                >
                  ...
                  <div
                    ...
                    style={{ width: 180, height: 180, border: "1px solid rgba(25,184,173,0.15)", borderRadius: "50%", right: -90, bottom: -90 }}
                  />
                  {/* Icon */}
                  <div
                    className="grid place-items-center shrink-0"
                    style={{ width: 34, height: 34, border: "1px solid rgba(124,227,218,0.3)", borderRadius: 10, color: "#18b8ad" }}
                  >
                  ...
                  <Link
                    href="/solutions/corporate"
                    style={{ color: "#18b8ad", fontSize: 10, fontWeight: 850 }}
      ...
      {/* ================================================================
          APPROACH / PROCESS — White section (5-step process)
          ================================================================ */}
      <section
        id="approach"
        className="py-24"
      ...
      >
        <div className="container-page">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-8">
            <div>
              <p
                style={{ fontSize: "10px", fontWeight: 900, letterSpacing: "0.2em", color: "#18b8ad" }}
                className="uppercase"
              >
                Methodology
              </p>
            ...
            <p
              ...
              style={{ color: "#68787d", fontSize: 14 }}
            >
          ...
          <div
            ...
            style={{ gridTemplateColumns: "repeat(4, 1fr)", borderTop: "1px solid #dce6e7" }}
          >
            {[
              ...
              <div
                ...
                style={{ borderRight: "1px solid #dce6e7", minHeight: 205 }}
              >
                <div
                  className="grid place-items-center"
                  style={{ width: 42, height: 42, borderRadius: "50%", background: "#e7f6f4", color: "#159f95" }}
                >
      ...
      >
        <div className="container-page">
          ...
          <RevealGroup
            className="mt-10 grid gap-2.5 grid-cols-2 md:grid-cols-3 lg:grid-cols-5"
          >
            {homeData.industries.tags.map((tag) => (
              <RevealItem key={tag}>
                <div
                  className="flex flex-col gap-2 p-5"
                  style={{ background: "#fff", border: "1px solid #dce6e7", borderRadius: 14 }}
                >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Reveal>
              <div
                ...
                style={{ minHeight: 300, borderRadius: 23, background: "#071820", color: "#fff" }}
              >
                <h3
                  className="font-serif"
                  style={{ fontSize: 31, fontWeight: 500, lineHeight: 1.06, maxWidth: 320 }}
                >
            ...
            {/* Light panel — Educational */}
            <Reveal delay={0.1}>
              <div
                className="flex flex-col gap-5 p-9"
                style={{ minHeight: 300, borderRadius: 23, background: "#fff", border: "1px solid #dce6e7" }}
              >
                <h3
                  className="font-serif"
                  style={{ fontSize: 31, fontWeight: 500, lineHeight: 1.06, maxWidth: 320, color: "#071820" }}
                >
                ...
                <div className="mt-auto grid grid-cols-2 gap-2">
                  {["Academic Analytics", "Curriculum Dev", "Assessment Tools", "Industry Programs"].map((t) => (
                    <div
                      ...
                      style={{ background: "#edf5f4", color: "#46575c" }}
                    >
                      {t}
                    </div>
                  ))}
        ...
        <div className="container-page">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-8 mb-11">
            <div>
              ...
              <h2
                className="font-serif mt-3"
                style={{ fontSize: "clamp(40px, 4.8vw, 61px)", lineHeight: 0.98, letterSpacing: "-0.05em", fontWeight: 500 }}
              >
            ...
            {SITE_CONFIG.blog.articles.slice(0, 3).map((post) => (
              <RevealItem key={post.slug}>
                <Link href={`/blog/${post.slug}`} className="block group">
                  <div
                    className="p-5 pt-6"
                    style={{ borderTop: "2px solid #18b8ad" }}
                  >
                    <p style={{ fontSize: 9, color: "#159b91", letterSpacing: "0.12em", fontWeight: 850 }} className="uppercase">
                      {post.category}
                    </p>
                    <h3
                      className="font-serif mt-4 group-hover:text-[#18b8ad] transition-colors"
                      style={{ fontSize: 23, lineHeight: 1.1, fontWeight: 500, color: "#071820" }}
                    >
                      {post.title}
                    </h3>
      ...
      {/* ================================================================
          FINAL CTA — Teal gradient (matches reference HTML)
          ================================================================ */}
      <section
        className="py-20"
